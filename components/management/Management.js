...
export default function Management() {
  return (
    ...
    <div className="w-3/4">
         <h1 className="text-center text-2xl text-slate-600 font-bold">Уважаемые жители Лиды и Лидского района</h1>
      <p className="py-4">
      ...
      <p className="py-4">
        ...
        исполком уполномочит управление общим имуществом КУП «Лидский
        государственный заказчик в сфере жилищно-коммунального хозяйства».
      </p>
      <p className="py-4">
      ...
      <p className="py-4">
        ...
        самостоятельно обращаться в КУП «Лидский государственный заказчик в
        сфере жилищно-коммунального хозяйства» по адресу: г. Лида, ул. Летная,
        7, тел. 8 0154 621065.
      </p>
